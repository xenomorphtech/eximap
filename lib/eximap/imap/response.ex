defmodule Eximap.Imap.Response do
  ...
  defp parse_message("tagged", resp, "NO " <> msg, rest),
    do: {:ok, append_to_response(resp, status: "NO", partial: false, message: msg), rest}

  defp parse_message("tagged", resp, "BAD " <> msg, rest),
    do: {:ok, append_to_response(resp, status: "BAD", partial: false, message: msg), rest}

  defp parse_message("tagged", resp, "OK " <> msg, rest),
    do: {:ok, append_to_response(resp, status: "OK", partial: false, message: msg), rest}

  defp parse_message("tagged", resp, msg, rest),
    do: {:ok, append_to_response(resp, status: "UNKNOWN", partial: false, message: msg), rest}
